...
public class TempDirWrap {
	...
	private String logMessages() throws IOException {
		...
		File outfile = new File(RefactorSession.MESSAGES_FILE);
		...
		return messages.toString()
			+ "Messages logged to " + RefactorSession.MESSAGES_FILE + " in your working directory.";
	}
	...
	private void writeTargetSource(int scanNum, String sourceFile) throws IOException {
		...
		if (outFile.exists()) {
			existingCopy = File.createTempFile("tdwrap", null, refpack.tempDir);
