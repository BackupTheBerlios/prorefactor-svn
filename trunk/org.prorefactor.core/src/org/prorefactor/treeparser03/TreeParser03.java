// $ANTLR 2.7.6 (2005-12-22): "expandedtreeparser03.g" -> "TreeParser03.java"$
...
inputState.guessing--;
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched1953 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t1953 = _t;
			synPredMatched1953 = true;
			inputState.guessing++;
			try {
				{
				AST __t1952 = _t;
				...
				synPredMatched1953 = false;
			}
			_t = __t1953;
inputState.guessing--;
		}
		if ( synPredMatched1953 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
			boolean synPredMatched1955 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==ERROR))) {
				AST __t1955 = _t;
				synPredMatched1955 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched1955 = false;
				}
				_t = __t1955;
inputState.guessing--;
			}
			if ( synPredMatched1955 ) {
		...
		case USING:
		{
			...
			do {
				...
				if ((_t.getType()==Field_ref)) {
					...
					if ( _cnt654>=1 ) { break _loop654; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void choosestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==Form_item)) {
				...
				if ( _cnt689>=1 ) { break _loop689; } else {throw new NoViableAltException(_t);}
			}
			...
			case IMAGEDOWN:
			{
				...
				do {
					...
					if ((_tokenSet_14.member(_t.getType()))) {
						...
						if ( _cnt1075>=1 ) { break _loop1075; } else {throw new NoViableAltException(_t);}
					}
			...
			case IMAGE:
			{
				...
				do {
					...
					if ((_tokenSet_14.member(_t.getType()))) {
						...
						if ( _cnt1078>=1 ) { break _loop1078; } else {throw new NoViableAltException(_t);}
					}
			...
			case IMAGEUP:
			{
				...
				do {
					...
					if ((_tokenSet_14.member(_t.getType()))) {
						...
						if ( _cnt1081>=1 ) { break _loop1081; } else {throw new NoViableAltException(_t);}
					}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1140>=1 ) { break _loop1140; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1143>=1 ) { break _loop1143; } else {throw new NoViableAltException(_t);}
				}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1277>=1 ) { break _loop1277; } else {throw new NoViableAltException(_t);}
				}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1344>=1 ) { break _loop1344; } else {throw new NoViableAltException(_t);}
				}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1400>=1 ) { break _loop1400; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1403>=1 ) { break _loop1403; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
		...
		if ( synPredMatched1672 ) {
			...
			boolean synPredMatched1693 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType() >= LEXDATE && _t.getType() <= Last_Token_Number)))) {
				AST __t1693 = _t;
				synPredMatched1693 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched1693 = false;
				}
				_t = __t1693;
inputState.guessing--;
			}
			if ( synPredMatched1693 ) {
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt1771>=1 ) { break _loop1771; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt1776>=1 ) { break _loop1776; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched1829 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t1829 = _t;
					synPredMatched1829 = true;
					inputState.guessing++;
					try {
						{
						AST __t1827 = _t;
						...
						synPredMatched1829 = false;
					}
					_t = __t1829;
inputState.guessing--;
				}
				if ( synPredMatched1829 ) {
					AST __t1830 = _t;
	...
	public final void updatestatement(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2207 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==UPDATE))) {
			AST __t2207 = _t;
			synPredMatched2207 = true;
			inputState.guessing++;
			try {
				{
				AST __t2206 = _t;
				...
				synPredMatched2207 = false;
			}
			_t = __t2207;
inputState.guessing--;
		}
		if ( synPredMatched2207 ) {
			sqlupdatestate(_t);
			_t = _retTree;
		}
		...
		case OBJCOLON:
		{
			...
			do {
				...
				if ((_t.getType()==OBJCOLON)) {
					...
					if ( _cnt516>=1 ) { break _loop516; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void aggregatephrase(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_tokenSet_38.member(_t.getType()))) {
				...
				if ( _cnt559>=1 ) { break _loop559; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void assign_opt(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==EQUAL)) {
				...
				if ( _cnt599>=1 ) { break _loop599; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
		...
		case PFCOLOR:
		{
			...
			do {
				...
				if ((_tokenSet_40.member(_t.getType()))) {
					...
					if ( _cnt731>=1 ) { break _loop731; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void formatphrase(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt1424>=1 ) { break _loop1424; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt1424++;
		} while (true);
	...
	public final void columnformat(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt768>=1 ) { break _loop768; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt768++;
		} while (true);
...
inputState.guessing--;
	...
	public final void goon_elem(AST _t) throws RecognitionException {
		...
		match(_t,_tokenSet_8);
		_t = _t.getNextSibling();
		}
		{
		boolean synPredMatched1515 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OF))) {
			AST __t1515 = _t;
			synPredMatched1515 = true;
			inputState.guessing++;
			try {
				{
				...
				synPredMatched1515 = false;
			}
			_t = __t1515;
inputState.guessing--;
		}
		if ( synPredMatched1515 ) {
	...
	public final void selectstatea(AST _t) throws RecognitionException {
		...
		case Sql_select_what:
		{
			...
			_t = _t.getFirstChild();
			{
			boolean synPredMatched2351 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2351 = _t;
				synPredMatched2351 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2351 = false;
				}
				_t = __t2351;
inputState.guessing--;
			}
			if ( synPredMatched2351 ) {
...
inputState.guessing--;
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2487 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2487 = _t;
				synPredMatched2487 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2487 = false;
				}
				_t = __t2487;
inputState.guessing--;
			}
			if ( synPredMatched2487 ) {
				AST __t2488 = _t;
	...
	public final void sqlaggregatefunc_arg(AST _t) throws RecognitionException {
		...
		default:
			if (_t==null) _t=ASTNULL;
			if ((_tokenSet_43.member(_t.getType()))) {
				{
				if (_t==null) _t=ASTNULL;
				if ((_t.getType()==ALL)) {
