		...
		case USING:
		{
			...
			do {
				...
				if ((_t.getType()==Field_ref)) {
					...
					if ( _cnt625>=1 ) { break _loop625; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void choosestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==Form_item)) {
				...
				if ( _cnt685>=1 ) { break _loop685; } else {throw new NoViableAltException(_t);}
			}
			...
			case IMAGEINSENSITIVE:
			{
				...
				do {
					...
					if ((_tokenSet_14.member(_t.getType()))) {
						...
						if ( _cnt1080>=1 ) { break _loop1080; } else {throw new NoViableAltException(_t);}
					}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1138>=1 ) { break _loop1138; } else {throw new NoViableAltException(_t);}
				}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1339>=1 ) { break _loop1339; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched1825 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t1825 = _t;
					synPredMatched1825 = true;
					inputState.guessing++;
					try {
						{
						AST __t1823 = _t;
						...
						synPredMatched1825 = false;
					}
					_t = __t1825;
inputState.guessing--;
				}
				if ( synPredMatched1825 ) {
					AST __t1826 = _t;
	...
	public final void updatestatement(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2203 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==UPDATE))) {
			AST __t2203 = _t;
			synPredMatched2203 = true;
			inputState.guessing++;
			try {
				{
				AST __t2202 = _t;
				...
				synPredMatched2203 = false;
			}
			_t = __t2203;
inputState.guessing--;
		}
		if ( synPredMatched2203 ) {
			sqlupdatestate(_t);
			_t = _retTree;
		}
	...
	public final void widattr(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==OBJCOLON)) {
				...
				if ( _cnt512>=1 ) { break _loop512; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void formatphrase(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt1419>=1 ) { break _loop1419; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt1419++;
		} while (true);
	...
	public final void columnformat(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt764>=1 ) { break _loop764; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt764++;
		} while (true);
...
inputState.guessing--;
	...
	public final void goon_elem(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched1510 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OF))) {
			AST __t1510 = _t;
			synPredMatched1510 = true;
			inputState.guessing++;
			try {
				{
				...
				synPredMatched1510 = false;
			}
			_t = __t1510;
inputState.guessing--;
		}
		if ( synPredMatched1510 ) {
	...
	public final void selectstatea(AST _t) throws RecognitionException {
		...
		case Sql_select_what:
		{
			...
			_t = _t.getFirstChild();
			{
			boolean synPredMatched2347 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2347 = _t;
				synPredMatched2347 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2347 = false;
				}
				_t = __t2347;
inputState.guessing--;
			}
			if ( synPredMatched2347 ) {
...
inputState.guessing--;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt2311>=1 ) { break _loop2311; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt2311++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2483 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2483 = _t;
				synPredMatched2483 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2483 = false;
				}
				_t = __t2483;
inputState.guessing--;
			}
			if ( synPredMatched2483 ) {
				AST __t2484 = _t;
