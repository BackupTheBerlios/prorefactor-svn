		...
		case USING:
		{
			...
			do {
				...
				if ((_t.getType()==Field_ref)) {
					...
					if ( _cnt479>=1 ) { break _loop479; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void choosestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==Form_item)) {
				...
				if ( _cnt514>=1 ) { break _loop514; } else {throw new NoViableAltException(_t);}
			}
			...
			case IMAGEINSENSITIVE:
			{
				...
				do {
					...
					if ((_tokenSet_9.member(_t.getType()))) {
						...
						if ( _cnt909>=1 ) { break _loop909; } else {throw new NoViableAltException(_t);}
					}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt964>=1 ) { break _loop964; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt967>=1 ) { break _loop967; } else {throw new NoViableAltException(_t);}
				}
			...
			if ((_t.getType()==INDEX)) {
				...
				do {
					...
					if ((_t.getType()==ID)) {
						...
						if ( _cnt1112>=1 ) { break _loop1112; } else {throw new NoViableAltException(_t);}
					}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1180>=1 ) { break _loop1180; } else {throw new NoViableAltException(_t);}
				}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1253>=1 ) { break _loop1253; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1328>=1 ) { break _loop1328; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void importstate(AST _t) throws RecognitionException {
		...
		case Field_ref:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1475>=1 ) { break _loop1475; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1475++;
			} while (true);
...
inputState.guessing--;
	...
	public final void onstate(AST _t) throws RecognitionException {
		...
		_t = _t.getFirstChild();
		{
		boolean synPredMatched1611 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_15.member(_t.getType())))) {
			AST __t1611 = _t;
			synPredMatched1611 = true;
			inputState.guessing++;
			try {
				{
				if (_t==null) _t=ASTNULL;
				...
				synPredMatched1611 = false;
			}
			_t = __t1611;
inputState.guessing--;
		}
		if ( synPredMatched1611 ) {
			{
			if (_t==null) _t=ASTNULL;
			switch ( _t.getType()) {
			case CREATE:
			...
			boolean synPredMatched1632 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType() >= LEXDATE && _t.getType() <= SYMMETRICENCRYPTIONALGORITHM)))) {
				AST __t1632 = _t;
				synPredMatched1632 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched1632 = false;
				}
				_t = __t1632;
inputState.guessing--;
			}
			if ( synPredMatched1632 ) {
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt1710>=1 ) { break _loop1710; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt1715>=1 ) { break _loop1715; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void updatestatement(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2191 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==UPDATE))) {
			AST __t2191 = _t;
			synPredMatched2191 = true;
			inputState.guessing++;
			try {
				{
				AST __t2190 = _t;
				...
				synPredMatched2191 = false;
			}
			_t = __t2191;
inputState.guessing--;
		}
		if ( synPredMatched2191 ) {
			sqlupdatestate(_t);
			_t = _retTree;
		}
...
inputState.guessing--;
	...
	public final void formatphrase(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt1349>=1 ) { break _loop1349; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt1349++;
		} while (true);
	...
	public final void columnformat(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt593>=1 ) { break _loop593; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt593++;
		} while (true);
	...
	public final void display_with(AST _t) throws RecognitionException {
		...
		boolean synPredMatched1213 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==WITH))) {
			AST __t1213 = _t;
			synPredMatched1213 = true;
			inputState.guessing++;
			try {
				{
				AST __t1212 = _t;
				...
				synPredMatched1213 = false;
			}
			_t = __t1213;
inputState.guessing--;
		}
		if ( synPredMatched1213 ) {
			AST __t1214 = _t;
...
inputState.guessing--;
	...
	public final void goon_elem(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched1440 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OF))) {
			AST __t1440 = _t;
			synPredMatched1440 = true;
			inputState.guessing++;
			try {
				{
				...
				synPredMatched1440 = false;
			}
			_t = __t1440;
inputState.guessing--;
		}
		if ( synPredMatched1440 ) {
