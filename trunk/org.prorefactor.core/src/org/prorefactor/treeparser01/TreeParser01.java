...
inputState.guessing--;
		...
		case OBJCOLON:
		{
			...
			do {
				...
				if ((_t.getType()==OBJCOLON)) {
					...
					if ( _cnt1582>=1 ) { break _loop1582; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void formatphrase(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt813>=1 ) { break _loop813; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt813++;
		} while (true);
			...
			if ((_t.getType()==INDEX)) {
				...
				do {
					...
					if ((_t.getType()==ID)) {
						...
						if ( _cnt614>=1 ) { break _loop614; } else {throw new NoViableAltException(_t);}
					}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt663>=1 ) { break _loop663; } else {throw new NoViableAltException(_t);}
				}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt789>=1 ) { break _loop789; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt792>=1 ) { break _loop792; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
		...
		if ( synPredMatched956 ) {
			...
			boolean synPredMatched977 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType() >= LEXDATE && _t.getType() <= SYMMETRICENCRYPTIONALGORITHM)))) {
				AST __t977 = _t;
				synPredMatched977 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched977 = false;
				}
				_t = __t977;
inputState.guessing--;
			}
			if ( synPredMatched977 ) {
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1280>=1 ) { break _loop1280; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1280++;
			} while (true);
