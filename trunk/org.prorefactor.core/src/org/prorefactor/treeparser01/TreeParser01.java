...
public TreeParser01() {
	...
	public final void formatphrase(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt840>=1 ) { break _loop840; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt840++;
		} while (true);
	...
	public final void assign_opt(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==EQUAL)) {
				...
				if ( _cnt1606>=1 ) { break _loop1606; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void display_with(AST _t) throws RecognitionException {
		...
		boolean synPredMatched1837 = false;
		if (((_t.getType()==WITH))) {
			AST __t1837 = _t;
			synPredMatched1837 = true;
			inputState.guessing++;
			try {
				{
				AST __t1836 = _t;
				...
				synPredMatched1837 = false;
			}
			_t = __t1837;
			inputState.guessing--;
		}
		if ( synPredMatched1837 ) {
			AST __t1838 = _t;
			...
			case IMAGEUP:
			{
				...
				do {
					...
					if ((_tokenSet_8.member(_t.getType()))) {
						...
						if ( _cnt456>=1 ) { break _loop456; } else {throw new NoViableAltException(_t);}
					}
			...
			case IMAGEINSENSITIVE:
			{
				...
				do {
					...
					if ((_tokenSet_8.member(_t.getType()))) {
						...
						if ( _cnt459>=1 ) { break _loop459; } else {throw new NoViableAltException(_t);}
					}
			...
			if ((_t.getType()==INDEX)) {
				...
				do {
					...
					if ((_t.getType()==ID)) {
						...
						if ( _cnt664>=1 ) { break _loop664; } else {throw new NoViableAltException(_t);}
					}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt711>=1 ) { break _loop711; } else {throw new NoViableAltException(_t);}
				}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt816>=1 ) { break _loop816; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt819>=1 ) { break _loop819; } else {throw new NoViableAltException(_t);}
				}
		...
		case PFCOLOR:
		{
			...
			do {
				...
				if ((_tokenSet_20.member(_t.getType()))) {
					...
					if ( _cnt1660>=1 ) { break _loop1660; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void importstate(AST _t) throws RecognitionException {
		...
		case Field_ref:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt926>=1 ) { break _loop926; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt926++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2461 = false;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2461 = _t;
				synPredMatched2461 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2461 = false;
				}
				_t = __t2461;
				inputState.guessing--;
			}
			if ( synPredMatched2461 ) {
				AST __t2462 = _t;
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2036>=1 ) { break _loop2036; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				match(_t,_tokenSet_31);
				_t = _t.getNextSibling();
				}
			}
			else {
				if ( _cnt2041>=1 ) { break _loop2041; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2166 = false;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t2166 = _t;
			synPredMatched2166 = true;
			inputState.guessing++;
			try {
				{
				AST __t2165 = _t;
				...
				synPredMatched2166 = false;
			}
			_t = __t2166;
			inputState.guessing--;
		}
		if ( synPredMatched2166 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
			boolean synPredMatched2168 = false;
			if (((_t.getType()==ERROR))) {
				AST __t2168 = _t;
				synPredMatched2168 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2168 = false;
				}
				_t = __t2168;
				inputState.guessing--;
			}
			if ( synPredMatched2168 ) {
