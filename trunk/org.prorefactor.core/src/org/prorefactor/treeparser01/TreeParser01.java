...
inputState.guessing--;
	...
	public final void display_with(AST _t) throws RecognitionException {
		...
		boolean synPredMatched1896 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==WITH))) {
			AST __t1896 = _t;
			synPredMatched1896 = true;
			inputState.guessing++;
			try {
				{
				AST __t1895 = _t;
		...
		case PFCOLOR:
		{
			...
			do {
				...
				if ((_tokenSet_22.member(_t.getType()))) {
					...
					if ( _cnt1697>=1 ) { break _loop1697; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2511 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2511 = _t;
				synPredMatched2511 = true;
				inputState.guessing++;
				try {
					{
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2100>=1 ) { break _loop2100; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2105>=1 ) { break _loop2105; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void goon_elem(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched1941 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OF))) {
			AST __t1941 = _t;
			synPredMatched1941 = true;
			inputState.guessing++;
			try {
				{
...
inputState.guessing--;
		...
		if ( synPredMatched2230 ) {
			...
			boolean synPredMatched2232 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==ERROR))) {
				AST __t2232 = _t;
				synPredMatched2232 = true;
				inputState.guessing++;
				try {
					{
