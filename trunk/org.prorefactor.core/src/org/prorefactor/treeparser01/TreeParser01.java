...
inputState.guessing--;
		...
		case OBJCOLON:
		{
			...
			do {
				...
				if ((_t.getType()==OBJCOLON)) {
					...
					if ( _cnt1587>=1 ) { break _loop1587; } else {throw new NoViableAltException(_t);}
				}
		...
		case USING:
		{
			...
			do {
				...
				if ((_t.getType()==Field_ref)) {
					...
					if ( _cnt170>=1 ) { break _loop170; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void formatphrase(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt818>=1 ) { break _loop818; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt818++;
		} while (true);
	...
	public final void columnformat(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt272>=1 ) { break _loop272; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt272++;
		} while (true);
	...
	public final void assign_opt(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==EQUAL)) {
				...
				if ( _cnt1649>=1 ) { break _loop1649; } else {throw new NoViableAltException(_t);}
			}
			...
			case IMAGE:
			{
				...
				do {
					...
					if ((_tokenSet_12.member(_t.getType()))) {
						...
						if ( _cnt410>=1 ) { break _loop410; } else {throw new NoViableAltException(_t);}
					}
			...
			case IMAGEINSENSITIVE:
			{
				...
				do {
					...
					if ((_tokenSet_12.member(_t.getType()))) {
						...
						if ( _cnt416>=1 ) { break _loop416; } else {throw new NoViableAltException(_t);}
					}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt471>=1 ) { break _loop471; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
			...
			if ((_t.getType()==INDEX)) {
				...
				do {
					...
					if ((_t.getType()==ID)) {
						...
						if ( _cnt619>=1 ) { break _loop619; } else {throw new NoViableAltException(_t);}
					}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt668>=1 ) { break _loop668; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void aggregatephrase(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_tokenSet_21.member(_t.getType()))) {
				...
				if ( _cnt1630>=1 ) { break _loop1630; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void functionstate(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched861 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==IN_KW))) {
				AST __t861 = _t;
				synPredMatched861 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched861 = false;
				}
				_t = __t861;
inputState.guessing--;
			}
			if ( synPredMatched861 ) {
	...
	public final void importstate(AST _t) throws RecognitionException {
		...
		case Field_ref:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt904>=1 ) { break _loop904; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt904++;
			} while (true);
...
inputState.guessing--;
	...
	public final void updatestatement(AST _t) throws RecognitionException {
		...
		boolean synPredMatched1210 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==UPDATE))) {
			AST __t1210 = _t;
			synPredMatched1210 = true;
			inputState.guessing++;
			try {
				{
				AST __t1209 = _t;
				...
				synPredMatched1210 = false;
			}
			_t = __t1210;
inputState.guessing--;
		}
		if ( synPredMatched1210 ) {
			sqlupdatestate(_t);
			_t = _retTree;
		}
...
inputState.guessing--;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1285>=1 ) { break _loop1285; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1285++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2517 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2517 = _t;
				synPredMatched2517 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2517 = false;
				}
				_t = __t2517;
inputState.guessing--;
			}
			if ( synPredMatched2517 ) {
				AST __t2518 = _t;
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2106>=1 ) { break _loop2106; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2111>=1 ) { break _loop2111; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched2149 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t2149 = _t;
					synPredMatched2149 = true;
					inputState.guessing++;
					try {
						{
						AST __t2147 = _t;
						...
						synPredMatched2149 = false;
					}
					_t = __t2149;
inputState.guessing--;
				}
				if ( synPredMatched2149 ) {
					AST __t2150 = _t;
...
inputState.guessing--;
	...
	public final void goon_elem(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched1947 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OF))) {
			AST __t1947 = _t;
			synPredMatched1947 = true;
			inputState.guessing++;
			try {
				{
				...
				synPredMatched1947 = false;
			}
			_t = __t1947;
inputState.guessing--;
		}
		if ( synPredMatched1947 ) {
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2236 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t2236 = _t;
			synPredMatched2236 = true;
			inputState.guessing++;
			try {
				{
				AST __t2235 = _t;
				...
				synPredMatched2236 = false;
			}
			_t = __t2236;
inputState.guessing--;
		}
		if ( synPredMatched2236 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
			boolean synPredMatched2238 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==ERROR))) {
				AST __t2238 = _t;
				synPredMatched2238 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2238 = false;
				}
				_t = __t2238;
inputState.guessing--;
			}
			if ( synPredMatched2238 ) {
