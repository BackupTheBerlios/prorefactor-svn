...
public class ProparseLdr {
	...
	public static String loadUsing(String fullpath) {
		...
		// Load proparse_jni.dll, which is supposed to be in the OS PATH.
		System.loadLibrary("proparse_jni");
	...
	private void initLib() {
		// We load proparse.dll here so that if it fails we get a Java exception,
		// which we can watch for and handle more gracefully.
		// Otherwise, with proparse_jni loading it, we would get a system error.
